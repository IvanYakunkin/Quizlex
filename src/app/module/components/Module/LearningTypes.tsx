...
export const LearningTypes = memo(() => {
    ...
    return (
        <div className={styles.learningTypes}>
            <Link href={id ? `/learn/module/${id}/cards` : "/learn/cards"} className={styles.learningBtn}> <Image src="/images/cards-white.png" width={50} height={50} alt="Cards" />Cards</Link>
            ...
            <Link href={id ? `/learn/module/${id}/match` : "/learn/match"} className={styles.learningBtn}><Image src="/images/choose.png" width={50} height={50} alt="Match" />Match</Link>
        </div>
    );
});
