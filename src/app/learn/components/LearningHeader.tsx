...
const LearningHeader = (props: LearningHeaderProps) => {
    ...
    return (
        <div className={styles.info}>
            <div className={`${styles.headerBtn}`} onClick={toHome}><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
