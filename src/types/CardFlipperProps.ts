export interface CardFlipperProps {
   ...
   * @default {}
   */
  containerStyle?: CardFlipperStyle;
  /**
  ...
  cardStyles?: { front?: Record<string, string>; back?: Record<string, string> };
  /**
...
export interface CardFlipperStyle{
    container: Record<string, string>;
    flipper: Record<string, string>;
