            ...
            <div className={styles.header__content}>
                ...
                {status === "authenticated" ? (
                    ...
                    <div className={styles.header__auth}>
                        <div className={styles.header__authElement} data-testid="logout-button" onClick={logout}>
                            <div>
                    ...
                    <div className={styles.header__auth}>
                        <div className={styles.header__authElement} onClick={showLoginForm} data-testid="auth-login-button">
                            <div>
                                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M20 12H8m12 0-4 4m4-4-4-4M9 4H7a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h2" />
                                </svg>
