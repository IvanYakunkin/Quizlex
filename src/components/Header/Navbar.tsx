...
const Navbar = ({isOpen, isAuthenticated, showLoginForm, setIsOpen}: NavbarProps) => {
    ...
    return (
        <nav className={isOpen ? `${styles.header__navbar} ${styles.active}` : styles.header__navbar}>
            <ul>
                <li>
                    <Link href="/import" className={styles.header__navbarElement}>
                ...
                {isAuthenticated ? (
                <li>
                    <Link href="/modules" className={styles.header__navbarElement}>
                        <svg aria-hidden="true" width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                : (
                    <Link href="/module" className={styles.header__navbarElement}>
                        <svg aria-hidden="true" width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18 14v4.833A1.166 1.166 0 0 1 16.833 20H5.167A1.167 1.167 0 0 1 4 18.833V7.167A1.166 1.166 0 0 1 5.167 6h4.618m4.447-2H20v5.768m-7.889 2.121 7.778-7.778"/>
                        </svg>
                ...
                {!isAuthenticated && 
                <li>
                    <div className={styles.header__navbarElement} onClick={() => {setIsOpen(false); showLoginForm()}}>
                ...
                {isAuthenticated &&
                <li>
                    <div className={styles.header__navbarElement} onClick={logout}>
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 12H8m12 0-4 4m4-4-4-4M9 4H7a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h2"/>
                        </svg>
                        <span>Logout</span>
