...
export const EditWin = (props: EditWinProps) => {
    ...
    return (
        ...
        <div className={styles.popup}>
            <Draggable nodeRef={wrapperRef} handle=".drag-handle" cancel=".cancel-drag">
                <div className={styles.container + " " + styles.big} ref={wrapperRef}>
                    <div className={styles.header + " drag-handle"}>
                        <div className={styles.title}>Edit card</div>
                        <div className={styles.close + " cancel-drag"} onClick={props.onClose}>
                            <svg
                                width="26"
                                height="26"
                                viewBox="0 0 24 24"
